...
class QLearningAgent(ReinforcementAgent):
    ...
    def getQValue(self, state, action):
        ...
        return QValue if QValue != 0 else 0.0
    ...
    def update(self, state, action, nextState, reward):
        ...
        next = (1 - self.alpha) * curr + self.alpha * (reward + self.discount * self.computeValueFromQValues(nextState))
        
        self.values[(state, action)] = next
